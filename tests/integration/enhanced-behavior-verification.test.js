      ...
      const existingScenarios = [
        {
          ...
          vessel: {
            sog: 4.2, dist: 200, towards: true, dir: 'Vänersborg',
          },
          expected: 'KEEP',
        },
        {
          name: 'Fast departure',
          vessel: {
            sog: 5.5, dist: 400, towards: false, dir: 'Göteborg',
          },
          expected: 'REMOVE',
        },
        {
          ...
          vessel: {
            sog: 0.3, dist: 40, towards: true, dir: 'Vänersborg', maxRecentSog: 4.0,
          },
          expected: 'KEEP',
        },
        {
          name: 'Anchored boat',
          vessel: {
            sog: 0.1, dist: 500, towards: false, dir: 'Göteborg', maxRecentSog: 0.2,
          },
          expected: 'REMOVE',
        },
      ];

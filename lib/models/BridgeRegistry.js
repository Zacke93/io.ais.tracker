...
class BridgeRegistry {
  ...
  _validateInterBridgeDistances(errors, warnings) {
    ...
    const EXPECTED_DISTANCES = {
      ...
      // C0 LANDAD 2026-08-10: baslinjen speglar konsensuspunkten
      // 58.309802/12.316748 (se BRIDGES.stallbackabron i lib/constants.js) —
      // haversine 2226,2 m. Tidigare 2310 (gamla, felplacerade koordinaten)
      // och dessförinnan 2415 (C0-planens äldre, falsifierade mål). Baslinjen,
      // BRIDGE_GAPS-paret och koordinaten flyttas ALLTID i samma commit —
      // annars faller självtestet.
      'stridsbergsbron-stallbackabron': { expected: 2226, tolerance: 300 },
    };

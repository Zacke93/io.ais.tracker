...
class BridgeRegistry {
  ...
  _validateInterBridgeDistances(errors, warnings) {
    ...
    const EXPECTED_DISTANCES = {
      ...
      // Fable-granskningen 2026-08-10 (FG-E2): SKA bli 2415 när C0 landar (se
      // BRIDGES.stallbackabron i lib/constants.js); 2310 stämmer mot dagens
      // (felplacerade) koordinatpunkt. Baslinjen måste flyttas i SAMMA commit
      // som punkten och som BRIDGE_GAPS-paret — annars faller självtestet.

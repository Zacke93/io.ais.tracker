...
const AIS_CONFIG = {
  ...
  AISHUB: {
    ...
    // Auth-fel (HTTP 401/403): efter 5 stoppas pollandet helt + notis.
    AUTH_FAIL_STOP: 5,
  ...
  FUSION: {
    ...
    // F5: källbyte med positionshopp > 150 m inom 30 s efter senast
    // accepterade fix ⇒ feedSwitch-flagga (undantar den globala jump-tallyn).
    FEED_SWITCH_DIST_M: 150,
    FEED_SWITCH_WINDOW_MS: 30000,
    // Per-MMSI-fusionsstate: TTL + hårt tak (LRU) — prunas i monitoring-takt.

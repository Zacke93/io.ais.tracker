...
const UI_CONSTANTS = {
  ...
  // Fix 2: ETA-staleness — om vessel.lastPositionUpdate är äldre än detta
  // när watchdog kör, sätts etaMinutes=null så bridge text visar "ETA okänd"
  // istället för en frusen gammal ETA. Vesseln finns kvar tills 30 min
  // STALE_AIS triggar borttagning.
  STALE_ETA_THRESHOLD_MS: 5 * 60 * 1000, // 5 min utan ny AIS → ETA blir null
};

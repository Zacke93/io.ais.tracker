...
class AISStreamClient extends EventEmitter {
  ...
  _onClose(code, reason) {
    ...
    // Helkodsgranskning 2026-07-01 (C1): gata ENBART på avsiktsflaggan. Både
    // disconnect() och reconnectWithKey() detachar lyssnarna före close, så
    // varje close som når hit är per definition oavsiktlig — en servergraceful
    // close med kod 1000 (deploy/omstart) måste också ge reconnect, annars är
    // feeden permanent död (watchdogen är gated på isConnected).

  ...
  _findShadowCounterpart(feed, msg) {
    ...
    for (let dLat = -1; dLat <= 1; dLat++) {
      for (let dLon = -1; dLon <= 1; dLon++) {
        ...
        // M28 (helkodsgranskning runda 4, 2026-08-23): jämförelsen läste
        // `best.storedAt`, ett fält som inte finns på best-objektet ({side, key,
        // entry, other}) ⇒ alltid undefined ⇒ första rutan i svepordningen vann i
        // stället för den FÄRSKASTE motparten. Skuggmätaren bytte därmed tecken på
        // fixLag-medianen (−7 396 → +12 051 ms, 71 → 79 par). Rätt fält är
        // best.side.storedAt.

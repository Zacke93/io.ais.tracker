...
class RouteOrderValidator {
  ...
  _determineDirection(cog) {
    ...
    // namngivna predikatfamiljen (lib/utils/cogDirection) — banden är
    // oförändrade, och normaliseringen ovan sker kvar HÄR eftersom predikaten
    // medvetet inte normaliserar.
    ...
    // för klassen. Därav det BREDA predikatet, inte det strikta.
    if (isSouthCogWide(normalizedCog)) {
      return 'south';
    }

...
class GPSJumpGateService {
  ...
  shouldBlockPassageDetection(vesselId, vessel, bridgeName) {
    ...
    // BÅDA flaggorna. Blockera därför även 'moderate', men bara när fartyget
    // står still (se helpern) - då är 100-500 m skenbar rörelse per definition
    // brus och inte transit.

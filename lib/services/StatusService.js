...
class StatusService extends EventEmitter {
  ...
  _isApproaching(vessel, proximityData) {
    ...
    if (targetDistance !== null) {
      ...
      // (icke-monoton flapp; FIX H kompenserar bara mellanbroarna). Gränsen
      // möter nu waiting-set exakt: 270 < d ≤ threshold = approaching,
      // d ≤ 270 = waiting (waiting prövas före approaching i huvudflödet
      // och är rent avståndsbaserad, så inget nytt dödband öppnas).

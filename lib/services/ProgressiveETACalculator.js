...
class ProgressiveETACalculator {
  ...
  _processETAWithProtection(vessel, rawETA, proximityData) {
    ...
    // Helgranskning 2026-07-06 (peta-1#1): gap-återställningen bor numera i
    // _applyGapResetIfNeeded och körs i BÖRJAN av calculateProgressiveETA —
    // här (STEP 2) var den för sen: rå-ETA:n hade redan beräknats med den
    // förgapskontaminerade hastighetsbufferten ([6,6,0]→4 kn för en båt som
    // stannat) och det felaktiga värdet släpptes igenom orört en hel cykel.

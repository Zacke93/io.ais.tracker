  ...
  _fire(event, members, due, firedBy, now) {
    ...
    if (eventDirection === 'mixed') {
      this.logger.debug(
        ...
        + 'eventDirection är null (den bär fortfarande den persistenta '
        + 'dedup-nyckeln bro|mmsi|riktning)',
      );
    }
    ...
    const payload = {
      ...
      // bara som fallback när eventDirection är null. Ledarens riktning bär
      // fortfarande den PERSISTENTA dedup-nyckeln (bro|mmsi|riktning), som
      // medvetet står kvar på interna ord.
      eventDirection,
      etaMinutes,
